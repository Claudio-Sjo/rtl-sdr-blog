...
if(BUILD_DAB_TIME)
    ...
    # Exclude audio decoder chain (needs mpg123 API unavailable on some systems)
    list(FILTER WELLE_BACKEND_SRC EXCLUDE REGEX "dab_decoder|decoder_adapter|dab-audio|dabplus_decoder")
